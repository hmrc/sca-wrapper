...
lazy val sharedSettings: Seq[sbt.Def.SettingsDefinition] = Seq(
  ...
  scalacOptions += "-Wconf:msg=constructor SafeRedirectUrl in class SafeRedirectUrl is deprecated.*:s",
  scalacOptions += "-Wconf:msg=method layout in class WrapperService is deprecated.*:s",
  scalacOptions += "-Wconf:msg=constructor AssetsBuilder in class AssetsBuilder is deprecated.*:s",

...
class ScaLayoutViewSpec extends ViewBaseSpec {
  ...
  "WrapperService layout" must {
    "return a Wrapper layout with default parameters in English" in {
      ...
      document.getElementsByAttributeValue("href", "https://www.gov.uk/government/organisations/hm-revenue-customs/contact").text() mustBe "Contact"
      document.getElementsByAttributeValue("href", "https://www.gov.uk/cymraeg").text() mustBe "Rhestr o Wasanaethau Cymraeg"
      ...
      document.select(".govuk-phase-banner__content").asScala.exists(x => x.text().equals("alpha This is a new service – your feedback will help us to improve it.")) mustBe true
    ...
    "return a Wrapper layout when showSignOutInHeader is true in English" in {
      ...
      document.getElementsByAttributeValue("data-module", "govuk-header").hasClass("hmrc-header--with-additional-navigation")
    ...
    "return a Wrapper layout there is a trusted helper in English" in {
      ...
      attorneyBannerElement.getElementsByClass("govuk-link pta-attorney-banner__link").attr("href") mustBe "returnLinkUrl"
      attorneyBannerElement.getElementsByClass("govuk-link pta-attorney-banner__link").text() mustBe "Return to your account"
